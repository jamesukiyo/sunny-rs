class SunnyCli < Formula
	...
	on_macos do
		if Hardware::CPU.intel?
			url "https://github.com/jamesukiyo/sunny-rs/releases/download/v0.5.0/sunny-cli-darwin-x64.tar.gz"
			sha256 "0cc0f7aefcc3b44ea99f9e1bb66ed990e4930c62f1efa6e5d952ebae4ad3b516"
		end
		if Hardware::CPU.arm?
			url "https://github.com/jamesukiyo/sunny-rs/releases/download/v0.5.0/sunny-cli-darwin-arm64.tar.gz"
	...
	on_linux do
		if Hardware::CPU.intel?
			url "https://github.com/jamesukiyo/sunny-rs/releases/download/v0.5.0/sunny-cli-linux-x64.tar.gz"
			sha256 "fed36b614f47bf05adb2772b66e0a72e068f1432f9d7dd1931351c9309e98a23"
		end
		if Hardware::CPU.arm?
			url "https://github.com/jamesukiyo/sunny-rs/releases/download/v0.5.0/sunny-cli-linux-arm64.tar.gz"
